# Symmetric counterpart to assoc_results_get(): writes an
...
#   assoc_results_save(results_inference, inference_detail, marker, folder)
...
# @keywords internal
assoc_results_save <- function(results_inference, inference_detail, marker,
                                     folder = NULL) {
  if (is.null(folder)) {
