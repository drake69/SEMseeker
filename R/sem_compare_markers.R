sem_compare_markers <- function(inference_detail, result_folder, studies, adjust_per_area = FALSE, adjust_globally = FALSE, pvalue_column = "PVALUE_ADJ_ALL_BH", adjustment_method = "BH", ...){
