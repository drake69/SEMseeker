...
#'
sem_analyze_population <- function(signal_data, sample_sheet,signal_thresholds, probe_features) {
  ...
  variables_to_export <- c("sample_sheet", "signal_data", "sem_analyze_single_sample", "ssEnv",
