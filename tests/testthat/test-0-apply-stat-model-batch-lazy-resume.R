# Regression: apply_stat_model_batch_lazy's resume-cache filter must accept an
...
test_that("apply_stat_model_batch_lazy filter mirrors the patched chain", {
  skip_on_cran()
  # Same shape used inside apply_stat_model_batch_lazy: AREA column carries
