...
pathway_*()               →  enriched pathways / networks (CSV in Pathway/)
      ↓
inter_study_enrichment_compare()       →  cross-cohort Venn diagrams
intra_study_enrichment_subsamples_overlaps()   →  stability across subsamples
```
...
| Replication across cohorts | `inter_study_enrichment_compare()` |
| Bootstrap stability check | `intra_study_enrichment_subsamples_overlaps()` |
