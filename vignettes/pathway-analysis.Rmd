...
|---|---|---|
| `enrich_WebGestalt()` | WebGestaltR [@WebGestaltR2023] | Gene Ontology ORA / GSEA |
| `enrich_STRINGdb()` | STRINGdb [@STRINGdb2023] | Protein-protein interaction network |
| `enrich_pathfindR()` | pathfindR [@pathfindR2019] | Active subnetwork enrichment |
| `enrich_ctdR()` | ctdR / CTD [@CTD2023] | Chemical-gene-disease associations |
...
| Replication across cohorts | `enrich_inter_study_enrichment_compare()` |
| Bootstrap stability check | `enrich_intra_study_enrichment_subsamples_overlaps()` |
